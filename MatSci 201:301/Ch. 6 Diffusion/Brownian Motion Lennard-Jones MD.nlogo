...
to-report calc-force [r]
  let cutoff-adjument 1.5380859375E-4   ; = force(cutoff-dist) without the adjustment
  report (- eps / (r ^ 7)) * ((r ^ -6) - 1) + cutoff-adjument
end
...
"" ""
PENS
"default" 1 2 -10899396 true "" "plotxy [vx] of particle 0 [vy] of particle 0"
"pen-1" 1 0 -7500403 true "" "plotxy 0 plot-y-min\nplotxy 0 plot-y-max\n"
"pen-2" 1 0 -7500403 true "" "plotxy plot-x-min 0 \nplotxy plot-x-max 0 \n"
