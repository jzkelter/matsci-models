...
to setup
  ...
  set green-vx-list (list)
  set green-vy-list (list)
  set all-vx-list (list)
  set all-vy-list (list)
  set dt .1
  set kb (3 / 1000)  ; just picking a random constant for Kb that makes things work reasonably
  set diameter .9
  set r-min 1
  set eps .02
...
to go
  ...
  ask particle 0 [
    set green-vx-list lput vx green-vx-list
    set green-vy-list lput vy green-vy-list
  ]
...
to-report current-temp
  report (1 /  Kb) * mean [vx ^ 2 + vy ^ 2] of particles
end
...
to update-force-and-velocity  ; particle procedure
  ...
  set all-vx-list lput vx all-vx-list
  set all-vy-list lput vy all-vy-list
...
"" ""
PENS
"default" 0.05 1 -13345367 true "" "histogram [vx] of particles"
...
"" ""
PENS
"default" 0.05 1 -13345367 true "" "histogram [vy] of particles"
...
"" ""
PENS
"default" 0.05 1 -10899396 true "" "histogram green-vy-list"
...
"" ""
PENS
"default" 0.05 1 -10899396 true "" "histogram green-vx-list"
