globals[
  ...
  DIAMETER
  POT-OFFSET
  MAX-MOVE-DIST CUTOFF-DIST
  Vtotal
  TOTAL-MOVE-ATTEMPTS TOTAL-SUCCESSFUL-MOVES CURRENT-MOVE-ATTEMPTS CURRENT-SUCCESSFUL-MOVES
]
breed [As A]
breed[Bs B]
...
to setup
  ...
  set DIAMETER sqrt(density-A * world-width * world-height / N-A) ;This is number density
  ...
  create-Bs N-B [
    set shape "circle"
    set size DIAMETER * B-DIAMETER-FRAC
    set color blue
  ]
...
to-report calc-V
  ...
  ask other turtles in-radius CUTOFF-DIST [
    ...
    let EPS get-potential-well [breed] of myself breed
...
to-report get-potential-well [breed1 breed2]
