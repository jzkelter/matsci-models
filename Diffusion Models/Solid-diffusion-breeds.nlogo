breed [a-atoms a-atom]
breed [b-atoms b-atom]
...
to setup
  ...
  ask patches with [pxcor < 0]
    [ sprout-a-atoms 1 [ set color green ] ]
  ;; make blue atoms on right
  ask patches with [pxcor > 0]
    [ sprout-b-atoms 1[ set color blue ] ]
...
590
651
Models Library Atoms By Column
NIL
NIL
0.0
10.0
...
PENS
"default" 1.0 0 -10899396 true "" "plot-atoms a-atoms"
"pen-1" 1.0 0 -13345367 true "" "plot-atoms b-atoms"
...
"set-plot-x-range min-pxcor (max-pxcor + 1)\n" ""
PENS
"default" 1.0 0 -10899396 true "" "histogram [pxcor] of a-atoms"
"pen-1" 1.0 0 -13345367 true "" "histogram [pxcor] of b-atoms"
...
"" ""
PENS
"default" 1.0 0 -16777216 true "" "plot (max([pxcor] of a-atoms) - min([pxcor] of b-atoms)) ^ 2"
